...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.agentDefinitionsSave]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentDefinitionsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentDefinitionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.workflowsListProfiles]: AuthOrchestrationReadScope,
