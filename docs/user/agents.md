...
Edit the files on disk and refresh the catalog to see changes. YAML files are not agent entries in this catalog. T3 does not execute agent modules. Verified workflow profiles can reference these folders and use their Markdown instructions; ordinary threads do not apply them yet.
