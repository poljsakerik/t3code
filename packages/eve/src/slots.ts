/**
 * Copied from vercel/eve, packages/eve/src/discover/slots.ts
 * https://github.com/vercel/eve/blob/505601b3f448a20aecc133e5d132d70c2ec3ee35/packages/eve/src/discover/slots.ts
 * Copyright 2026 Vercel, Inc. and contributors. Apache-2.0 (see ../LICENSE and ../NOTICE).
 * Modified for T3: use structural directory entries without a Node dependency.
 */
import { getSupportedModuleBaseName } from "./filesystem.ts";
