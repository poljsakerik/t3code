...
After a task and its agents finish, choose **Request review** in the thread. Web and desktop also offer **Request review** in the command palette. Select one or more project agents and start the reviews; they run in parallel using their configured models, instructions, and skills.
